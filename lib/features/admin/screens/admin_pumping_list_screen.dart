...
class AdminPumpingListScreen extends StatefulWidget {
  const AdminPumpingListScreen({super.key});

  @override
  State<AdminPumpingListScreen> createState() => _AdminPumpingListScreenState();
}

class _AdminPumpingListScreenState extends State<AdminPumpingListScreen> {
  ...
  Future<void> _loadRequests() async {
    ...
    try {
      final requests = await _adminService.getPumpingRequests();
      if (mounted) {
        setState(() {
          _requests = requests;
          _isLoading = false;
